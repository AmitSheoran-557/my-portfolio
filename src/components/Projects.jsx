                ...
                <div className="flex flex-wrap 2xl:gap-6 xl:gap-5 gap-4 justify-center">
                    {filteredProjects.map((project, index) => (
                        <div className="project-cards" key={index}>
                            <div className=" bg-white/60 border xl:max-w-[366px] lg:max-w-[310px] sm:max-w-[330px] max-w-sm lg:h-[421px] sm:h-[420px] border-zinc-300 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl backdrop-blur-md transition-all ease-linear duration-300 group relative">
